...
#   Unknown type 'SYS.AQ$_SUBSCRIBERS' for column 'subscribers'
  ...
  create_table "def$_temp$lob", id: false, comment: "Storage for LOB parameters to RPCs", force: :cascade do |t|
    t.binary "temp$blob", comment: "Binary LOB (deferred) RPC parameter"
    t.text "temp$clob", comment: "Character LOB (deferred) RPC parameter"
    t.ntext "temp$nclob", comment: "National Character LOB (deferred) RPC parameter"
  end
...
#   Unknown type 'ROWID' for column 'bad_rowid'
  ...
  create_table "mview$_adv_index", id: false, force: :cascade do |t|
    t.decimal "runid#", null: false
    t.decimal "rank#", null: false
    t.decimal "mvindex#", null: false
    t.decimal "index_type"
    t.string "index_name", limit: 50
    t.string "column_name", limit: 32
    t.string "index_content", limit: 2000
    t.string "summary_owner", limit: 32
  end
...
#   Unknown type 'LONG' for column 'query_text'
  ...
  create_table "mview$_adv_owb", temporary: true, id: false, force: :cascade do |t|
    t.decimal "runid#"
    t.string "objname", limit: 30
    t.string "ownername", limit: 30
    t.text "mvscript"
    t.text "indexscript"
  end
...
# Could not dump table "mview$_adv_partition" because of following StandardError
#   Unknown type 'LONG' for column 'query_text'
